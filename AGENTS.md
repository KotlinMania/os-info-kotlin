...
This file is the quick-reference operating contract for os-info-kotlin. The longer
...
os-info-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`os_info`](https://crates.io/crates/os_info). Upstream Rust is the behavioral oracle while the
