...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `OsInfo.swiftmodule/`
...
//      `import OsInfo` above would fail at compile time.
//
//   2. The static archive `libOsInfo.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "OsInfo" }` and
...
final class OsInfoExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "OsInfo swift module imported cleanly")
    }
}
